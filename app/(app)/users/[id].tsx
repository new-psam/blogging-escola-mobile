...
import {
    ...
    Text,
    TextInput,
    TouchableOpacity, // 🌟 ADICIONE AQUI
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          {/* Precisamos dessa View com flex: 1 para o clique funcionar na tela toda */}
          <View style={{ flex: 1 }}>
              ...
              {isEditingSelf ? (
                <View style={styles.selfWarningContainer}>
                  <Text style={styles.selfWarningContainerText}>
                    Você não pode alterar seu próprio nível de acesso por motivo
                    de segurança.
                  </Text>
                </View>
              ) : (
